...
class Book {
    ...
    public:
        ...
        Book operator ++ (int) {
            ...
            return result; // Return original values
        }
};
    ...
    public:
        ...
        bool doBorrow(Book* abook) {
            if ( abook->borrow(name) == false ) {
                return false; // Borrow fail: no available copies
            }
...
int main(){
    ...
    book1.borrow("An"); book1.borrow("Huy"); book1.returns("An");
    book2.borrow("Petter"); book2.borrow("John"); book2.returns("John");
    book1.showInfo();
    book2.showInfo();
    ...
    User User1("User1");
    User1.doBorrow(&book1); User1.doBorrow(&book2);
