...
int main() {
    ...
    // Revert str1
    // Swap the first characters with the last characters until the middle
    ...
    // Convert from lowercase to uppercase and vice versa
    ...
    + use strlen(str) instead of str.length()
    */
